...
class WasteAnalysisLoadingPage extends ConsumerStatefulWidget {
  const WasteAnalysisLoadingPage({Key? key}) : super(key: key);

  @override
  WasteAnalysisLoadingPageState createState() => WasteAnalysisLoadingPageState();
}

class WasteAnalysisLoadingPageState extends ConsumerState<WasteAnalysisLoadingPage> {
  @override
  void initState() {
    super.initState();
  }
